            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 13:
                        ...
                        return [3 /*break*/, 16];
                    case 14: return [4 /*yield*/, this.app.workspace.openLinkText(dailyNote.path, "", this.settings.openDailyInNewPane, this.getViewStateFromMode(parameters))];
                    case 15:
                        _a.sent();
                        _a.label = 16;
                    case 16:
